...
<head>
  ...
  <title>Sorteos | <?= $this->renderSection('title') ?></title> <!-- AdminLTE 3 | Inicio -->
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">S<?= $this->renderSection('title') ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="content">
      ...
      <?= $this->renderSection('content') ?> <!-- Contenido de la pagina-->
